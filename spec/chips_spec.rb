...
describe P4::Chips do
  ...
  it "User#chips object should have certain public methods" do
    expect((p1.chips.methods - Object.instance_methods).sort).to eq [:buy, :gain, :lose, :reserve]
  ...
  it ".fix_game should return proper hash and create proper Balance and Transaction objects" do
    ...
    p2.chips.buy 200 do |qty|;end
    p3.chips.buy 200 do |qty|;end
  ...
  it ".game_results_valid?" do
    p1.chips.buy 500 do |qty|;end
    p2.chips.buy 500 do |qty|;end
    p3.chips.buy 500 do |qty|;end
